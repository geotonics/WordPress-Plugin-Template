<?php
/**
 * Document for class WordPress_Plugin_Template_Settings
 *
 * PHP Version 5.6
 *
 * @category Class
...
class WordPress_Plugin_Template_Settings
{
	...
	/**
	 * Constructor for WordPress_Plugin_Template_Settings class
	...
	public function add_menu_item() {
		...
		$page = add_options_page( __( 'Plugin Template Settings', 'wordpress-plugin-template' ), __( 'Plugin Template', 'wordpress-plugin-template' ), 'manage_options', $this->parent->_token . '_settings',  array( $this, 'settings_page' ) );
	}
	...
	public function settings_page() {
		...
		echo '<div class="wrap" id="' . esc_attr( $this->parent->_token ) . '_settings">
			<h2>' . esc_attr( __( 'Plugin Template', 'wordpress-plugin-template' ) ) . '</h2>';
		...
		echo '<p class="submit">
			...
			<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings', 'wordpress-plugin-template' ) ) . '" />
			</p>
			</form>
		</div>';
	}
	...
	/**
	 * Adds column WordPress Plugin Template data.
	 *
	...
	public function new_users_column( $cols ) {
		...
		$cols['wordpress-plugin-template'] = 'WordPress Plugin Template';
		return $cols;
	}

	/**
	 * Provided data for column with links to WordPress Plugin Template data.
	 *
	...
	public function new_users_column_data( $existing_string, $col_name, $user_object_userID ) {
		...
		if ( 'wordpress-plugin-template' !== $col_name ) {
