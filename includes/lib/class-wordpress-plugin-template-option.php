<?php
/**
 * Document for class WordPress_Plugin_Template_Option
 *
 * PHP Version 5.6
 *
 * @category Class
 ...
 */
class WordPress_Plugin_Template_Option
{
	/**
	...
	/**
	 * Main WordPress_Plugin_Template_Option Instance
	 *
	 * Ensures only one instance of WordPress_Plugin_Template_Option is loaded or can be loaded.
	 *
	 * @since  1.0.0
	 * @static
	 * @see    WordPress_Plugin_Template()
	 * @param  Object $parent Main WordPress_Plugin_Template instance.
	 * @return Main WordPress_Plugin_Template_Option instance
	 */
