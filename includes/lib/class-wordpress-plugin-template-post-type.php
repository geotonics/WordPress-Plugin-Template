<?php
/**
 * Document for class WordPress_Plugin_Template_Post_Type
 *
 * PHP Version 5.6
 *
 * @category Class
...
class WordPress_Plugin_Template_Post_Type
{
	...
	/**
	 * Constructor for WordPress_Plugin_Template_Post_Type
	 *
	...
	public function updated_messages( $messages = array() ) {
		...
		5 => isset( $_GET['revision'] ) ? sprintf( __( '%1$s restored to revision from %2$s.', 'wordpress-plugin-template' ), $this->single, wp_post_revision_title( (int) $_GET['revision'], false ) ) : false, // Input var okay.
